...
Route::namespace('Admin')->prefix('admin')->name('admin.')->middleware(['auth','can:admin-access'])->group(function () {
    ...
    Route::get('/attendance', 'EmployeeController@attendance')->name('employees.attendance');
    Route::post('/attendance', 'EmployeeController@attendance')->name('employees.attendance');
    Route::delete('/attendance/{attendance_id}', 'EmployeeController@attendanceDelete')->name('employees.attendance.delete');
    ...
    // Routes for recap //
    Route::get('/recap', 'EmployeeController@recap')->name('recap.index');
    Route::get('/recap/print/{filter_req}', 'EmployeeController@printRecap')->name('recap.print');
...
Route::namespace('Employee')->prefix('employee')->name('employee.')->middleware(['auth','can:employee-access'])->group(function () {
    ...
    */
    ...
    Route::get('/leaves/edit-leave/{employee_id}/{leave_id}', 'LeaveController@edit')->name('leaves.edit');
    Route::put('/leaves/{leave_id}', 'LeaveController@update')->name('leaves.update');
